...
public class JsonSerdeUtil {
    ...
    static {
        ...
        OBJECT_MAPPER_INSTANCE.registerModules(createJacksonModule(), new JavaTimeModule());
    }
    ...
    private static Module createJacksonModule() {
        SimpleModule module = new SimpleModule("FileSystem");
        registerJsonObjects(
                module,
                TableSchema.class,
        ...
        module.addSerializer(
                new StdSerializer<T>(clazz) {
                    ...
                    public void serialize(T t, JsonGenerator generator, SerializerProvider provider)
                            throws IOException {
                        serializer.serialize(t, generator, provider);
                    }
                });
    ...
    public static JsonParser traverse(TreeNode node, ObjectCodec objectCodec) throws IOException {
