...
/** {@link RefreshHandlerSerializer} for {@link DolphinSchedulerRefreshHandler}. */
@PublicEvolving
public class DolphinSchedulerRefreshHandlerSerializer
    ...
    @Override
    public DolphinSchedulerRefreshHandler deserialize(byte[] serializedBytes, ClassLoader cl)
