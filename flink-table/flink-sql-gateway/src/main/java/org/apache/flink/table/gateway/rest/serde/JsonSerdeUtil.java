...
public class JsonSerdeUtil {
    ...
    static {
        ...
        OBJECT_MAPPER_INSTANCE.registerModules(createJacksonModule());
    }
    ...
    private static Module createJacksonModule() {
        SimpleModule module = new SimpleModule("Sql Gateway Module");
    ...
    private static void registerSerializers(SimpleModule module) {
        module.addSerializer(new ContinuousJobInfoSerializer());
        module.addSerializer(new SchedulerJobInfoSerializer());
    }

    private static void registerDeserializers(SimpleModule module) {
        module.addDeserializer(ContinuousJobInfo.class, new ContinuousJobInfoDeserializer());
        module.addDeserializer(SchedulerJobInfo.class, new SchedulerJobInfoDeserializer());
    }
}
