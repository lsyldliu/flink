...
public class QuartzSchedulerUtils {
    ...
    /**
     * This method is used to initializing the scheduler config, the related options copy from
     * quartz.properties file, but we override the option {@code org.quartz.threadPool.threadCount}
