...
/** CREATE DYNAMIC TABLE DDL sql call. */
public class SqlCreateDynamicTable extends SqlCreate implements ExtendedSqlNode {

    public static final SqlSpecialOperator OPERATOR =
            new SqlSpecialOperator("CREATE DYNAMIC TABLE", SqlKind.CREATE_TABLE);
    ...
    public void unparse(SqlWriter writer, int leftPrec, int rightPrec) {
        writer.keyword("CREATE DYNAMIC TABLE");
    ...
    public void validate() throws SqlValidateException {
        // TODO: validate Primary Key nullability, Partition Key

        // TODO validate freshness and its unit
    }
}
