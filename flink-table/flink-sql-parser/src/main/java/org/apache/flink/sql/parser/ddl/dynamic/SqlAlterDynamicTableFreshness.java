...
/** ALTER DYNAMIC TABLE ... SET FRESHNESS sql call. */
public class SqlAlterDynamicTableFreshness extends SqlAlterDynamicTable {

    private final SqlIntervalLiteral freshness;

    public SqlAlterDynamicTableFreshness(
            SqlParserPos pos, SqlIdentifier tableIdentifier, SqlIntervalLiteral freshness) {
