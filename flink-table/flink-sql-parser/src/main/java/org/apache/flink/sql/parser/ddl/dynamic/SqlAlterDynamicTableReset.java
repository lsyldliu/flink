...
/** ALTER DYNAMIC TABLE [[catalogName.] dataBasesName].tableName RESET ( 'key1' [, 'key2']*). */
public class SqlAlterDynamicTableReset extends SqlAlterDynamicTable {

    private final SqlNodeList propertyKeyList;

    public SqlAlterDynamicTableReset(
            SqlParserPos pos, SqlIdentifier tableIdentifier, SqlNodeList propertyKeyList) {
