...
/**
 * ALTER DYNAMIC TABLE [[catalogName.] dataBasesName].tableName SET ( name=value [, name=value]*).
 */
public class SqlAlterDynamicTableOptions extends SqlAlterDynamicTable {

    private final SqlNodeList propertyList;

    public SqlAlterDynamicTableOptions(
