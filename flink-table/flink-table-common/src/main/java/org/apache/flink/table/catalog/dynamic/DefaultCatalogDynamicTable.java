...
@Internal
public class DefaultCatalogDynamicTable implements CatalogDynamicTable {
    ...
    @Override
    public CatalogDynamicTable copy(Map<String, String> options) {
        return new DefaultCatalogDynamicTable(
                schema,
                comment,
                partitionKeys,
    ...
    public boolean equals(Object o) {
        ...
        DefaultCatalogDynamicTable that = (DefaultCatalogDynamicTable) o;
    ...
    public String toString() {
        return "DefaultCatalogDynamicTable{"
                + "schema="
                + schema
                + ", comment='"
                + comment
