...
public class WorkflowSchedulerFactoryUtil {
     ...
     * the scheduler.
     */
    public static WorkflowScheduler createWorkflowScheduler(
    ...
    public static Map<String, String> getWorkflowSchedulerConfig(
    ...
    public static String getWorkflowSchedulerOptionPrefix(String identifier) {
    ...
    public static WorkflowSchedulerFactoryHelper createWorkflowSchedulerFactoryHelper(
        ...
        return new WorkflowSchedulerFactoryHelper(workflowSchedulerFactory, context);
    }
