...
public final class BatchMultipleFusionSourceStreamOperatorBaseline
    ...
    private static AtomicLong readyToJoinRowNum = new AtomicLong(0);
    ...
    public BatchMultipleFusionSourceStreamOperatorBaseline(
            ...
            case 1:
                LOG.info(
                        "Task {} ending catalog_sales probe, column batch num: {}, total row num: {}, date_dim filter row num: {},"
                                + " call_center filter row num: {}, ship_mode filter row num: {}, warehouse filter row num: {}, ready to join row num: {},"
    ...
    private void processCatalogSalesJoin(
        ...
        catalogSalesRowNum.incrementAndGet();
        ...
        // join date_dim first
        readyToJoinRowNum.incrementAndGet();
